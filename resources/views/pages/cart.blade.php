        ...
        <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="address1" name="address1" value="Setra Duta Cemara" />
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="address2" name="address2" value="Blok B2 No. 34" />
            </div>
          </div>
          ...
          <div class="col-md-4">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="zipCode" name="zipCode" value="123999" />
            </div>
          </div>
