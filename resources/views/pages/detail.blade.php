...
<div class="page-content page-details">
    ...
    <div class="store-details-container mt-3">
        ...
        <section class="store-review">
            <div class="container">
                <div class="row">
                    <div class="col-12 col-lg-8 mt-3 mb-3" data-aos="fade-up">
                ...
                <div class="row">
                    <div class="col-12 col-lg-8" data-aos="fade-up">
                        <ul class="list-unstyled">
                            <li class="media">
                                <img src="/images/icon-review1.png" alt="" class="mr-3 rounded-circle" />
                            ...
                            <li class="media">
                                <img src="/images/icon-review2.png" alt="" class="mr-3 rounded-circle" />
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">
                                        Anna Sukkirata
                                    </h5>
                            ...
                            <li class="media">
                                <img src="/images/icon-review3.png" alt="" class="mr-3 rounded-circle" />
                                <div class="media-body">
                                    <h5 class="mt-2 mb-1">
                                        Dakimu Wangi
                                    </h5>
